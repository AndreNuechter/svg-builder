...
const drawingBoundingRect = svg.getBoundingClientRect(); // TODO: this leads to faulty offsets...replacing instances w the value seems wasteful tho...initialize it on load and update it on resize?
...
const drawing = {};
const defaultConfig = { // TODO import this
    dims: {
        width: 320,
        height: 180,
        transforms: {
